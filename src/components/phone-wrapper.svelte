...
<div class="absolute flex w-[30rem] h-[63rem]" style="scale: 0.8">
  <button 
  ...
  <!-- Phone content -->
  <div class="w-full h-full bg-black rounded-[3.5rem] shadow-frame flex z-10 p-3 overflow-hidden">
    <Notch />
    <div class="w-full h-full rounded-[3rem] bg-cover bg-black overflow-hidden relative" style="background-image: url({Background});">
      <header class="absolute z-50 flex items-center justify-between w-full px-8 pt-4">
